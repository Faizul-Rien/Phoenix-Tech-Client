...
const Articles = () => {
    return (
        <div>
            <h2 style={{marginBottom:'-100px'}} className='text-3xl text-center text-green-300 font-bold '>Recent Tech Article</h2>
            <div class="hero min-h-screen">
        <div class="hero-content flex-col lg:flex-row-reverse">
          <img className='max-w-lg rounded-lg shadow-2xl' src={article} alt=''/>
          <div>
